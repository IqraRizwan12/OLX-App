    ...
    return (
        <div>
            <div style={{ backgroundColor: 'beige', padding: '10px' }}>
                ...
                <a href="https://www.olx.com.pk/jobs_c4" style={{ padding: '10px', fontSize: 'x-large', border: '1px solid black', borderRadius: '10px', marginRight: '10px', color: 'black', textDecoration: 'none' }}>Login</a>
                <a href="https://www.olx.com.pk/jobs_c4" style={{ padding: '10px', fontSize: 'x-large', border: '1px solid black', borderRadius: '10px', marginRight: '10px', color: 'black', textDecoration: 'none' }}>Sell</a>
            ...
            <div style={{ backgroundColor: 'beige', padding: '10px' }} >
                ...
                <div style={{ display: "inline-block", marginLeft: '200px' }}>
                    <h3>FOLLOW US</h3>
                    <img width={100} src='https://independenceinc.org/wp-content/uploads/social-media-icons.jpg' /><br />
                    <img width={200} src='https://miro.medium.com/v2/resize:fit:816/1*sSR4mrpijxoQrD7HKu8nDw.png' />
                </div>
